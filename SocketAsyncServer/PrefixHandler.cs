    ...
    class PrefixHandler
    {
        ...
        {            
            ...
            if (remainingBytesToProcess >= receiveSendToken.receivePrefixLength - receiveSendToken.receivedPrefixBytesDoneCount)
            {
                ...
                //receiveSendToken.lengthOfCurrentIncomingMessage = BitConverter.ToInt16(receiveSendToken.byteArrayForPrefix, 0);
                receiveSendToken.lengthOfCurrentIncomingMessage = receiveSendToken.byteArrayForPrefix[0] * 256 + receiveSendToken.byteArrayForPrefix[1];
