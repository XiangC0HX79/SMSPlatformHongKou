...
namespace SocketAsyncServer
{
    class SocketListenerSettings
    {
        ...
        //Empp
        private String empp_host;
        private Int32  empp_port;
        private String empp_accountId;
        private String empp_password;	
        ...
        public SocketListenerSettings(Int32 maxConnections, Int32 excessSaeaObjectsInPool, Int32 backlog, Int32 maxSimultaneousAcceptOps, Int32 receivePrefixLength, Int32 receiveBufferSize, Int32 sendPrefixLength, Int32 opsToPreAlloc, IPEndPoint theLocalEndPoint
            , String empp_host, Int32 empp_port, String empp_accountId, String empp_password)
        {
            ...
            this.empp_host = empp_host;
            this.empp_port = empp_port;
            this.empp_accountId = empp_accountId;
            this.empp_password = empp_password;
        }
        ...
        public String Empp_Host
        {
            get
            {
                return this.empp_host;
            }
        }
        public Int32 Empp_Port
        {
            get
            {
                return this.empp_port;
            }
        }
        public String Empp_AccountId
        {
            get
            {
                return this.empp_accountId;
            }
        }
        public String Empp_Password
        {
            get
            {
                return this.empp_password;
            }
        }    
    }    
}
