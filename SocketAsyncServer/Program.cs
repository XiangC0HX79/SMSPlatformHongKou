...
namespace SocketAsyncServer
{
    class Program
    {
        //public static string conStr = @"Provider=Microsoft.Jet.OLEDB.4.0;User ID=Admin;Data Source=..\App_Data\Data.mdb;Extended Properties=";
        ...
        public const Int32 receivePrefixLength = 2;
        public const Int32 sendPrefixLength = 2;                
        ...
        //Empp
        public const string empp_host = "211.136.163.68";
        public const int empp_port = 9981;
        public const string empp_accountId = "10657109080176";
        //public const string empp_password = "Passw0rd";	
        ...
        static void Main(String[] args)
        {
            ...
            try
            {
                ...
                //you would create.string connectionString =
                ...
                Object o = clsGetData.GetValue("SELECT 参数值 FROM 系统设置 WHERE 参数名称 = '平台密码'");
                if (o == null)
                {
                    Console.WriteLine("Error: " + clsGetData.ErrorString);
                    Program.testWriter.WriteLine("初始化错误: " + clsGetData.ErrorString);
                }
                else
                {
                    string empp_password = clsGetData.GetValue("SELECT 参数值 FROM 系统设置 WHERE 参数名称 = '平台密码'").ToString();
            ...
            , empp_host, empp_port, empp_accountId, empp_password);
            ...
            catch (Exception ex)
            {
                ...
                Program.testWriter.WriteLine("初始化错误: " + ex.Message);
            }
            finally
            {   
